...
;; ***	genFunction  2342 curr label offset=16previous max_key=4 
_itoa	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	1109 rIdx = r0x1053 
	.line	45; "UART.c"	void itoa(unsigned int val, char* str )
	BANKSEL	r0x1000
	MOVWF	r0x1000
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1361:mov2w_op
	.line	47; "UART.c"	str[0]=((val%1000)/100)+0x30;
	MOVLW	0xe8
;; 	2135 left AOP_LIT
...
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1907:assignResultValue *{*
;; ***	assignResultValue  1909
;; 	line = 1911 result -=-, size=0, left AOP_REG=r0x1057, size=2, right -=-, size=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x1058 
	BANKSEL	r0x1005
	MOVWF	r0x1005
...
;;	694 register type nRegs=1
;; 	line = 618 result AOP_REG=r0x1057, size=1, left AOP_REG=r0x1059, size=1, right AOP_LIT=0x30, size=1
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:534:genAddLit
	MOVLW	0x30
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:535:genAddLit
;;	1109 rIdx = r0x1059 
	ADDWF	r0x1007,W
...
;;	694 register type nRegs=3
;;	694 register type nRegs=3
;; 	line = 618 result AOP_REG=r0x1057, size=3, left AOP_REG=r0x1054, size=3, right AOP_LIT=0x01, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:142:genPlusIncr *{*
;; ***	genPlusIncr  144
;; 	result AOP_REG, left AOP_REG, right AOP_LIT
;; 	genPlusIncr  156
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:546:genAddLit
	.line	48; "UART.c"	str[1]=((val%100)/10)+0x30;
	MOVLW	0x01
...
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1907:assignResultValue *{*
;; ***	assignResultValue  1909
;; 	line = 1911 result -=-, size=0, left AOP_REG=r0x105B, size=2, right -=-, size=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x105C 
	BANKSEL	r0x1009
	MOVWF	r0x1009
...
;;	694 register type nRegs=1
;;	694 register type nRegs=1
;; 	line = 618 result AOP_REG=r0x105B, size=1, left AOP_REG=r0x105D, size=1, right AOP_LIT=0x30, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:142:genPlusIncr *{*
;; ***	genPlusIncr  144
;; 	result AOP_REG, left AOP_REG, right AOP_LIT
;; 	genPlusIncr  156
...
;;	694 register type nRegs=3
;;	694 register type nRegs=3
;; 	line = 618 result AOP_REG=r0x1057, size=3, left AOP_REG=r0x1054, size=3, right AOP_LIT=0x02, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:142:genPlusIncr *{*
;; ***	genPlusIncr  144
;; 	result AOP_REG, left AOP_REG, right AOP_LIT
;; 	genPlusIncr  156
...
;;  left and result aren't same	genAddLit  514
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:546:genAddLit
	.line	49; "UART.c"	str[2]=(val%10)+0x30;
	MOVLW	0x02
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:547:genAddLit
;;	1109 rIdx = r0x1054 
	BANKSEL	r0x1004
...
;;	694 register type nRegs=1
;;	694 register type nRegs=1
;; 	line = 618 result AOP_REG=r0x1052, size=1, left AOP_REG=r0x105B, size=1, right AOP_LIT=0x30, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:142:genPlusIncr *{*
;; ***	genPlusIncr  144
;; 	result AOP_REG, left AOP_REG, right AOP_LIT
;; 	genPlusIncr  156
...
;;	694 register type nRegs=3
;;	694 register type nRegs=3
;; 	line = 618 result AOP_REG=r0x1054, size=3, left AOP_REG=r0x1054, size=3, right AOP_LIT=0x03, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:142:genPlusIncr *{*
;; ***	genPlusIncr  144
;; 	result AOP_REG, left AOP_REG, right AOP_LIT
;; 	genPlusIncr  156
...
;;	694 register type nRegs=3
;; 	line = 6624 result AOP_REG=r0x1054, size=3, left AOP_LIT=0x00, size=1, right -=-, size=0
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1343:mov2w_op *{*
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1361:mov2w_op
	MOVLW	0x00
...
;  pBlock Stats: dbName = C
;***
;entry:  _UART_tx_str	;Function start
; 2 exit points
;has an exit
;functions called:
;   __gptrget1
...
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2340:genFunction *{*
;; ***	genFunction  2342 curr label offset=8previous max_key=4 
_UART_tx_str	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7358:genReceive *{*
;; ***	genReceive  7359
...
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1907:assignResultValue *{*
;; ***	assignResultValue  1909
;; 	line = 1911 result -=-, size=0, left AOP_REG=r0x104A, size=3, right -=-, size=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x104C 
	.line	34; "UART.c"	void UART_tx_str(const char* val)
	BANKSEL	r0x100D
	MOVWF	r0x100D
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1423:get_returnvalue
;; ***	popRegFromIdx,1042  , rIdx=0x7f
...
;;	694 register type nRegs=1
;;	694 register type nRegs=3
;; 	line = 618 result AOP_REG=r0x104E, size=3, left AOP_REG=r0x104A, size=3, right AOP_REG=r0x104D, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:142:genPlusIncr *{*
;; ***	genPlusIncr  144
...
;;	694 register type nRegs=3
;;	694 register type nRegs=1
;; 	line = 6057 result AOP_REG=r0x1051, size=1, left AOP_REG=r0x104E, size=3, right -=-, size=0
;; ***	mov2w  1381  offset=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1386:mov2w
;;	1109 rIdx = r0x104E 
	MOVF	r0x1011,W
...
;; ***	popGetLabel  key=1, label offset 16
	GOTO	_00117_DS_
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
;; ***	genLabel  2763
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x1048 
	.line	26; "UART.c"	void UART_tx(const unsigned char val)
	BANKSEL	r0x100C
	MOVWF	r0x100C
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
...
;;	_TXSTAbits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:5783:genUnpackBits
_00109_DS_
	.line	29; "UART.c"	while(!(UART_TX_REGISTER_STATUS)); // wait till Transmit Shift Register Status bit is empty
	BANKSEL	_TXSTAbits
	BTFSS	_TXSTAbits,1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:5784:genUnpackBits
...
;; 	line = 6937 result AOP_DIR=_TXREG, size=1, left -=-, size=0, right AOP_REG=r0x1048, size=1
;; ***	genAssign  7023
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1343:mov2w_op *{*
;; ***	mov2w  1381  offset=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1386:mov2w
;;	1109 rIdx = r0x1048 
	.line	30; "UART.c"	UART_TX_REGISTER = val; // send data
	BANKSEL	r0x100C
	MOVF	r0x100C,W
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:5783:genUnpackBits
_00112_DS_
	.line	31; "UART.c"	while(UART_TX_GET_FLAG == 0); // wait till The USART transmit buffer is empty
	BANKSEL	_PIR1bits
	BTFSS	_PIR1bits,4
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:5784:genUnpackBits
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _UART_tx
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*

;***
;  pBlock Stats: dbName = C
;***
;entry:  _UART_init	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_TXSTAbits
;; 	line = 6523 result AOP_PCODE=_TXSTAbits, size=2, left -=-, size=0, right AOP_LIT=0x00, size=1
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	17; "UART.c"	EIGHT_BITS_MODE;
	BANKSEL	_TXSTAbits
	BCF	_TXSTAbits,6
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_RCSTAbits
;; 	line = 6523 result AOP_PCODE=_RCSTAbits, size=2, left -=-, size=0, right AOP_LIT=0x00, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6249:genPackBits *{*
;; ***	genPackBits  6250
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_RCSTAbits
...
;;	_RCSTAbits
	BTFSC	_RCSTAbits,6
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:5810:genUnpackBits
	MOVLW	0x00
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6686:genPointerSet *{*
...
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_TXSTAbits
;; 	line = 6523 result AOP_PCODE=_TXSTAbits, size=2, left -=-, size=0, right AOP_LIT=0x01, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6249:genPackBits *{*
;; ***	genPackBits  6250
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_TXSTAbits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	18; "UART.c"	ENABLE_TRANSMISSION;
	BANKSEL	_TXSTAbits
	BSF	_TXSTAbits,5
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_RCSTAbits
;; 	line = 6523 result AOP_PCODE=_RCSTAbits, size=2, left -=-, size=0, right AOP_LIT=0x01, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6249:genPackBits *{*
;; ***	genPackBits  6250
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_RCSTAbits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	21; "UART.c"	ENABLE_SERIAL_PORT;
	BANKSEL	_RCSTAbits
	BSF	_RCSTAbits,7
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	_RCSTAbits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	22; "UART.c"	CONTINUOUS_RECIEVING;
	BSF	_RCSTAbits,4
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6927:genAssign *{*
;; ***	genAssign  6928
...
;; 	line = 6937 result AOP_DIR=_SPBRG, size=1, left -=-, size=0, right AOP_LIT=0x19, size=1
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7030:genAssign
	.line	23; "UART.c"	BUAD_RATE_9600_4MH;
	MOVLW	0x19
